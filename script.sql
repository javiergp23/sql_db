...
CREATE TABLE IF NOT EXISTS `mydb`.`order_detail` (
  ...
  `Product_idt` INT NOT NULL,
  `id` INT NOT NULL,
  `order_detailcol` VARCHAR(45) NULL,
  PRIMARY KEY (`order_id`, `id`),
  INDEX `fk_order_has_Product_Product1_idx` (`Product_idt` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_order_has_Product_Product1`
    FOREIGN KEY (`Product_idt`)
    REFERENCES `mydb`.`Product` (`idt`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
